    ...
    return (
        [
            ...
            },
            {
                ...
                technologies: ['JavaScript', 'React.js', 'Node.js', 'MongoDB', 'Mongoose', 'Express.js', 'Plaid API', 'SCSS', 'Framer-Motion', 'React-Icons'],
                demoUrl: '#projects',
                codeUrl: "#",
                classified: true,
            },
            {
                ...
                jobDescription: [
                    ...
                    'Utilized best practices in code organization, BEM naming conventions, Higher Order Components, to write clean, efficient, maintainable, and scalable code',
